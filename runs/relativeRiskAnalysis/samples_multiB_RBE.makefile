...
RBEMAX1_CION_BLADDER_LOW = 5
RBEMAX1_CION_BLADDER_MODE = 6
RBEMAX1_CION_BLADDER_HIGH = 7
...
RBEMAX2_CION_BLADDER_LOW = 2.5
RBEMAX2_CION_BLADDER_MODE = 3.0
RBEMAX2_CION_BLADDER_HIGH = 3.5
...
RBEMAX1_PROTON_BLADDER_LOW = 1.2
RBEMAX1_PROTON_BLADDER_MODE = 1.25
RBEMAX1_PROTON_BLADDER_HIGH = 1.3
...
RBEMAX2_PROTON_BLADDER_LOW = 0.6
RBEMAX2_PROTON_BLADDER_MODE = 0.625
RBEMAX2_PROTON_BLADDER_HIGH = 0.65
...
CION_BLADDER_FILELIST = $(foreach N,$(FILEIDS),cion_bladder_samples_multiB_RBE_$(N).mat)
CION_RECTUM_FILELIST = $(foreach N,$(FILEIDS),cion_rectum_samples_multiB_RBE_$(N).mat)
PROTON_BLADDER_FILELIST = $(foreach N,$(FILEIDS),proton_bladder_samples_multiB_RBE_$(N).mat)
PROTON_RECTUM_FILELIST = $(foreach N,$(FILEIDS),proton_rectum_samples_multiB_RBE_$(N).mat)
FILELIST = $(CION_BLADDER_FILELIST) $(CION_RECTUM_FILELIST) $(PROTON_BLADDER_FILELIST) $(PROTON_RECTUM_FILELIST)

OUTPUT_FILES = cion_bladder_sample_multiB_RBE_data.mat \
...
cleanall: clean
	rm -rf make_samples_multiB_RBE merge_samples_multiB_RBE $(OUTPUT_FILES)


define merge_samples_multiB_RBE
#!/bin/sh
outfile="$$1"
shift
...
EOF
endef
export merge_samples_multiB_RBE

merge_samples_multiB_RBE: samples_multiB_RBE.makefile
	echo "$$merge_samples_multiB_RBE" > $@
	chmod +x $@


define make_samples_multiB_RBE
#!/bin/sh
exec $(OCTAVE) <<EOF
Nsamples = $$2;
...
EOF
endef
export make_samples_multiB_RBE

make_samples_multiB_RBE: samples_multiB_RBE.makefile
	echo "$$make_samples_multiB_RBE" > $@
	chmod +x $@


$(CION_BLADDER_FILELIST): make_samples_multiB_RBE
	./make_samples_multiB_RBE $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
cion_bladder_sample_multiB_RBE_data.mat: merge_samples_multiB_RBE $(CION_BLADDER_FILELIST)
	./merge_samples_multiB_RBE $@ $(CION_BLADDER_FILELIST) && \
		rm -f $@.backup $(CION_BLADDER_FILELIST) $(foreach N,$(CION_BLADDER_FILELIST),log_$(N).txt)


$(CION_RECTUM_FILELIST): make_samples_multiB_RBE
	./make_samples_multiB_RBE $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
cion_rectum_sample_multiB_RBE_data.mat: merge_samples_multiB_RBE $(CION_RECTUM_FILELIST)
	./merge_samples_multiB_RBE $@ $(CION_RECTUM_FILELIST) && \
		rm -f $@.backup $(CION_RECTUM_FILELIST) $(foreach N,$(CION_RECTUM_FILELIST),log_$(N).txt)


$(PROTON_BLADDER_FILELIST): make_samples_multiB_RBE
	./make_samples_multiB_RBE $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
proton_bladder_sample_multiB_RBE_data.mat: merge_samples_multiB_RBE $(PROTON_BLADDER_FILELIST)
	./merge_samples_multiB_RBE $@ $(PROTON_BLADDER_FILELIST) && \
		rm -f $@.backup $(PROTON_BLADDER_FILELIST) $(foreach N,$(PROTON_BLADDER_FILELIST),log_$(N).txt)


$(PROTON_RECTUM_FILELIST): make_samples_multiB_RBE
	./make_samples_multiB_RBE $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
proton_rectum_sample_multiB_RBE_data.mat: merge_samples_multiB_RBE $(PROTON_RECTUM_FILELIST)
	./merge_samples_multiB_RBE $@ $(PROTON_RECTUM_FILELIST) && \
