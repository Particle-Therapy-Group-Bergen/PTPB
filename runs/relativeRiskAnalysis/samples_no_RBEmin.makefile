...
CION_BLADDER_FILELIST = $(foreach N,$(FILEIDS),cion_bladder_samples_no_RBEmin_$(N).mat)
CION_RECTUM_FILELIST = $(foreach N,$(FILEIDS),cion_rectum_samples_no_RBEmin_$(N).mat)
PROTON_BLADDER_FILELIST = $(foreach N,$(FILEIDS),proton_bladder_samples_no_RBEmin_$(N).mat)
PROTON_RECTUM_FILELIST = $(foreach N,$(FILEIDS),proton_rectum_samples_no_RBEmin_$(N).mat)
FILELIST = $(CION_BLADDER_FILELIST) $(CION_RECTUM_FILELIST) $(PROTON_BLADDER_FILELIST) $(PROTON_RECTUM_FILELIST)

OUTPUT_FILES = cion_bladder_sample_no_RBEmin_data.mat \
               cion_rectum_sample_no_RBEmin_data.mat \
               proton_bladder_sample_no_RBEmin_data.mat \
               proton_rectum_sample_no_RBEmin_data.mat
...
cleanall: clean
	rm -rf make_samples_no_RBEmin merge_samples_no_RBEmin $(OUTPUT_FILES)


define merge_samples_no_RBEmin
#!/bin/sh
outfile="$$1"
shift
...
EOF
endef
export merge_samples_no_RBEmin

merge_samples_no_RBEmin: samples_no_RBEmin.makefile
	echo "$$merge_samples_no_RBEmin" > $@
	chmod +x $@


define make_samples_no_RBEmin
#!/bin/sh
exec $(OCTAVE) <<EOF
Nsamples = $$2;
...
EOF
endef
export make_samples_no_RBEmin

make_samples_no_RBEmin: samples_no_RBEmin.makefile
	echo "$$make_samples_no_RBEmin" > $@
	chmod +x $@


$(CION_BLADDER_FILELIST): make_samples_no_RBEmin
	./make_samples_no_RBEmin $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
cion_bladder_sample_no_RBEmin_data.mat: merge_samples_no_RBEmin $(CION_BLADDER_FILELIST)
	./merge_samples_no_RBEmin $@ $(CION_BLADDER_FILELIST) && \
		rm -f $@.backup $(CION_BLADDER_FILELIST) $(foreach N,$(CION_BLADDER_FILELIST),log_$(N).txt)


$(CION_RECTUM_FILELIST): make_samples_no_RBEmin
	./make_samples_no_RBEmin $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
cion_rectum_sample_no_RBEmin_data.mat: merge_samples_no_RBEmin $(CION_RECTUM_FILELIST)
	./merge_samples_no_RBEmin $@ $(CION_RECTUM_FILELIST) && \
		rm -f $@.backup $(CION_RECTUM_FILELIST) $(foreach N,$(CION_RECTUM_FILELIST),log_$(N).txt)


$(PROTON_BLADDER_FILELIST): make_samples_no_RBEmin
	./make_samples_no_RBEmin $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
proton_bladder_sample_no_RBEmin_data.mat: merge_samples_no_RBEmin $(PROTON_BLADDER_FILELIST)
	./merge_samples_no_RBEmin $@ $(PROTON_BLADDER_FILELIST) && \
		rm -f $@.backup $(PROTON_BLADDER_FILELIST) $(foreach N,$(PROTON_BLADDER_FILELIST),log_$(N).txt)


$(PROTON_RECTUM_FILELIST): make_samples_no_RBEmin
	./make_samples_no_RBEmin $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
proton_rectum_sample_no_RBEmin_data.mat: merge_samples_no_RBEmin $(PROTON_RECTUM_FILELIST)
	./merge_samples_no_RBEmin $@ $(PROTON_RECTUM_FILELIST) && \
