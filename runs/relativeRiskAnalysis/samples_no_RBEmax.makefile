...
CION_BLADDER_FILELIST = $(foreach N,$(FILEIDS),cion_bladder_samples_no_RBEmax_$(N).mat)
CION_RECTUM_FILELIST = $(foreach N,$(FILEIDS),cion_rectum_samples_no_RBEmax_$(N).mat)
PROTON_BLADDER_FILELIST = $(foreach N,$(FILEIDS),proton_bladder_samples_no_RBEmax_$(N).mat)
PROTON_RECTUM_FILELIST = $(foreach N,$(FILEIDS),proton_rectum_samples_no_RBEmax_$(N).mat)
FILELIST = $(CION_BLADDER_FILELIST) $(CION_RECTUM_FILELIST) $(PROTON_BLADDER_FILELIST) $(PROTON_RECTUM_FILELIST)

OUTPUT_FILES = cion_bladder_sample_no_RBEmax_data.mat \
               cion_rectum_sample_no_RBEmax_data.mat \
               proton_bladder_sample_no_RBEmax_data.mat \
               proton_rectum_sample_no_RBEmax_data.mat
...
cleanall: clean
	rm -rf make_samples_no_RBEmax merge_samples_no_RBEmax $(OUTPUT_FILES)


define merge_samples_no_RBEmax
#!/bin/sh
outfile="$$1"
shift
...
EOF
endef
export merge_samples_no_RBEmax

merge_samples_no_RBEmax: samples_no_RBEmax.makefile
	echo "$$merge_samples_no_RBEmax" > $@
	chmod +x $@


define make_samples_no_RBEmax
#!/bin/sh
exec $(OCTAVE) <<EOF
Nsamples = $$2;
...
EOF
endef
export make_samples_no_RBEmax

make_samples_no_RBEmax: samples_no_RBEmax.makefile
	echo "$$make_samples_no_RBEmax" > $@
	chmod +x $@


$(CION_BLADDER_FILELIST): make_samples_no_RBEmax
	./make_samples_no_RBEmax $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
cion_bladder_sample_no_RBEmax_data.mat: merge_samples_no_RBEmax $(CION_BLADDER_FILELIST)
	./merge_samples_no_RBEmax $@ $(CION_BLADDER_FILELIST) && \
		rm -f $@.backup $(CION_BLADDER_FILELIST) $(foreach N,$(CION_BLADDER_FILELIST),log_$(N).txt)


$(CION_RECTUM_FILELIST): make_samples_no_RBEmax
	./make_samples_no_RBEmax $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
cion_rectum_sample_no_RBEmax_data.mat: merge_samples_no_RBEmax $(CION_RECTUM_FILELIST)
	./merge_samples_no_RBEmax $@ $(CION_RECTUM_FILELIST) && \
		rm -f $@.backup $(CION_RECTUM_FILELIST) $(foreach N,$(CION_RECTUM_FILELIST),log_$(N).txt)


$(PROTON_BLADDER_FILELIST): make_samples_no_RBEmax
	./make_samples_no_RBEmax $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
proton_bladder_sample_no_RBEmax_data.mat: merge_samples_no_RBEmax $(PROTON_BLADDER_FILELIST)
	./merge_samples_no_RBEmax $@ $(PROTON_BLADDER_FILELIST) && \
		rm -f $@.backup $(PROTON_BLADDER_FILELIST) $(foreach N,$(PROTON_BLADDER_FILELIST),log_$(N).txt)


$(PROTON_RECTUM_FILELIST): make_samples_no_RBEmax
	./make_samples_no_RBEmax $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
...
proton_rectum_sample_no_RBEmax_data.mat: merge_samples_no_RBEmax $(PROTON_RECTUM_FILELIST)
	./merge_samples_no_RBEmax $@ $(PROTON_RECTUM_FILELIST) && \
