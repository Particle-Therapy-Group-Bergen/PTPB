...
# This makefile is used for producing 1D scans of the alpha parameter around the
# nominal point.

ITERATIONS = 10
N_SAMPLES = 1000

ALPHA_CION_BLADDER_MIN = 0.01
ALPHA_CION_BLADDER_MAX = 0.8
...
ALPHA_CION_RECTUM_MIN = $(ALPHA_CION_BLADDER_MIN)
ALPHA_CION_RECTUM_MAX = $(ALPHA_CION_BLADDER_MAX)
...
ALPHA_PROTON_BLADDER_MIN = $(ALPHA_CION_BLADDER_MIN)
ALPHA_PROTON_BLADDER_MAX = $(ALPHA_CION_BLADDER_MAX)
...
ALPHA_PROTON_RECTUM_MIN = $(ALPHA_CION_RECTUM_MIN)
ALPHA_PROTON_RECTUM_MAX = $(ALPHA_CION_RECTUM_MAX)
...
CION_BLADDER_FILELIST = $(foreach N,$(FILEIDS),alpha_scan_cion_bladder_samples_$(N).mat)
CION_RECTUM_FILELIST = $(foreach N,$(FILEIDS),alpha_scan_cion_rectum_samples_$(N).mat)
PROTON_BLADDER_FILELIST = $(foreach N,$(FILEIDS),alpha_scan_proton_bladder_samples_$(N).mat)
PROTON_RECTUM_FILELIST = $(foreach N,$(FILEIDS),alpha_scan_proton_rectum_samples_$(N).mat)
FILELIST = $(CION_BLADDER_FILELIST) $(CION_RECTUM_FILELIST) $(PROTON_BLADDER_FILELIST) $(PROTON_RECTUM_FILELIST)

OUTPUT_FILES = alpha_scan_cion_bladder_sample_data.mat \
               alpha_scan_cion_rectum_sample_data.mat \
               alpha_scan_proton_bladder_sample_data.mat \
               alpha_scan_proton_rectum_sample_data.mat
...
cleanall: clean
	rm -rf make_alpha_scan_samples merge_alpha_scan_samples $(OUTPUT_FILES)


define merge_alpha_scan_samples
#!/bin/sh
outfile="$$1"
shift
...
EOF
endef
export merge_alpha_scan_samples

merge_alpha_scan_samples: alpha_scan_samples.makefile
	echo "$$merge_alpha_scan_samples" > $@
	chmod +x $@


define make_alpha_scan_samples
#!/bin/sh
exec $(OCTAVE) <<EOF
Nsamples = $$2;
...
scale2 = $$8;
organ = '$$9';
alpha_distrib = struct('type', 'box', 'params', {{$$10, $$11}});
...
EOF
endef
export make_alpha_scan_samples

make_alpha_scan_samples: alpha_scan_samples.makefile
	echo "$$make_alpha_scan_samples" > $@
	chmod +x $@


$(CION_BLADDER_FILELIST): make_alpha_scan_samples
	./make_alpha_scan_samples $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
		'data/CionDataPhysicalDose/HUH%dphysical_dvh.mat' 12 1 Bladder \
		$(ALPHA_CION_BLADDER_MIN) $(ALPHA_CION_BLADDER_MAX) \
...
alpha_scan_cion_bladder_sample_data.mat: merge_alpha_scan_samples $(CION_BLADDER_FILELIST)
	./merge_alpha_scan_samples $@ $(CION_BLADDER_FILELIST) && \
		rm -f $@.backup $(CION_BLADDER_FILELIST) $(foreach N,$(CION_BLADDER_FILELIST),log_$(N).txt)


$(CION_RECTUM_FILELIST): make_alpha_scan_samples
	./make_alpha_scan_samples $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
		'data/CionDataPhysicalDose/HUH%dphysical_dvh.mat' 12 1 Rectum \
		$(ALPHA_CION_RECTUM_MIN) $(ALPHA_CION_RECTUM_MAX) \
...
alpha_scan_cion_rectum_sample_data.mat: merge_alpha_scan_samples $(CION_RECTUM_FILELIST)
	./merge_alpha_scan_samples $@ $(CION_RECTUM_FILELIST) && \
		rm -f $@.backup $(CION_RECTUM_FILELIST) $(foreach N,$(CION_RECTUM_FILELIST),log_$(N).txt)


$(PROTON_BLADDER_FILELIST): make_alpha_scan_samples
	./make_alpha_scan_samples $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
		'data/IMPTdvh/impt%d.mat' 25 1/1.1 Bladder \
		$(ALPHA_PROTON_BLADDER_MIN) $(ALPHA_PROTON_BLADDER_MAX) \
...
alpha_scan_proton_bladder_sample_data.mat: merge_alpha_scan_samples $(PROTON_BLADDER_FILELIST)
	./merge_alpha_scan_samples $@ $(PROTON_BLADDER_FILELIST) && \
		rm -f $@.backup $(PROTON_BLADDER_FILELIST) $(foreach N,$(PROTON_BLADDER_FILELIST),log_$(N).txt)


$(PROTON_RECTUM_FILELIST): make_alpha_scan_samples
	./make_alpha_scan_samples $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
		'data/IMPTdvh/impt%d.mat' 25 1/1.1 Rectum \
		$(ALPHA_PROTON_RECTUM_MIN) $(ALPHA_PROTON_RECTUM_MAX) \
...
alpha_scan_proton_rectum_sample_data.mat: merge_alpha_scan_samples $(PROTON_RECTUM_FILELIST)
	./merge_alpha_scan_samples $@ $(PROTON_RECTUM_FILELIST) && \
