...
plotMeanDVH.py --density --gnuplot --extra-curves "$N_EXTRA_CURVES" --outfile bladder.png samples_cion_bladder.mat samples_vmat_bladder.mat samples_impt_bladder.mat
...
plotMeanDVH.py --density --gnuplot --extra-curves "$N_EXTRA_CURVES" --outfile rectum.png samples_cion_rectum.mat samples_vmat_rectum.mat samples_impt_rectum.mat
