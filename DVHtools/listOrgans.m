function listOrgans(inputArg)
%listOrgans
%listOrgans(data)
%listOrgans(filename)
%
% Lists all organ names and positions in the DVH data.
%
...
%
% Running example: listOrgans('DVHinput.mat')
%
...
printf('No.\tOrgan Name\n');
for n = 1:length(organs)
    printf('%d\t''%s''\n', n, organs{n}.structName);
end
