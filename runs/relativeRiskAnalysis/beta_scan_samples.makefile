...
# This makefile is used for producing 1D scans of the beta parameter around the
# nominal point.
...
BETA_CION_BLADDER_MIN = 0.01
BETA_CION_BLADDER_MAX = 0.05
...
BETA_CION_RECTUM_MIN = 0.01
BETA_CION_RECTUM_MAX = 0.05
...
BETA_PROTON_BLADDER_MIN = $(BETA_CION_BLADDER_MIN)
BETA_PROTON_BLADDER_MAX = $(BETA_CION_BLADDER_MAX)
...
BETA_PROTON_RECTUM_MIN = $(BETA_CION_RECTUM_MIN)
BETA_PROTON_RECTUM_MAX = $(BETA_CION_RECTUM_MAX)
...
CION_BLADDER_FILELIST = $(foreach N,$(FILEIDS),beta_scan_cion_bladder_samples_$(N).mat)
CION_RECTUM_FILELIST = $(foreach N,$(FILEIDS),beta_scan_cion_rectum_samples_$(N).mat)
PROTON_BLADDER_FILELIST = $(foreach N,$(FILEIDS),beta_scan_proton_bladder_samples_$(N).mat)
PROTON_RECTUM_FILELIST = $(foreach N,$(FILEIDS),beta_scan_proton_rectum_samples_$(N).mat)
FILELIST = $(CION_BLADDER_FILELIST) $(CION_RECTUM_FILELIST) $(PROTON_BLADDER_FILELIST) $(PROTON_RECTUM_FILELIST)

OUTPUT_FILES = beta_scan_cion_bladder_sample_data.mat \
               beta_scan_cion_rectum_sample_data.mat \
               beta_scan_proton_bladder_sample_data.mat \
               beta_scan_proton_rectum_sample_data.mat
...
cleanall: clean
	rm -rf make_beta_scan_samples merge_beta_scan_samples $(OUTPUT_FILES)


define merge_beta_scan_samples
#!/bin/sh
outfile="$$1"
shift
...
EOF
endef
export merge_beta_scan_samples

merge_beta_scan_samples: beta_scan_samples.makefile
	echo "$$merge_beta_scan_samples" > $@
	chmod +x $@


define make_beta_scan_samples
#!/bin/sh
exec $(OCTAVE) <<EOF
Nsamples = $$2;
...
beta_distrib = struct('type', 'box', 'params', {{$$12, $$13}});
...
EOF
endef
export make_beta_scan_samples

make_beta_scan_samples: beta_scan_samples.makefile
	echo "$$make_beta_scan_samples" > $@
	chmod +x $@


$(CION_BLADDER_FILELIST): make_beta_scan_samples
	./make_beta_scan_samples $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
		'data/CionDataPhysicalDose/HUH%dphysical_dvh.mat' 12 1 Bladder \
		$(ALPHA_CION_BLADDER_MEAN) $(ALPHA_CION_BLADDER_STD) \
		$(BETA_CION_BLADDER_MIN) $(BETA_CION_BLADDER_MAX) \
...
beta_scan_cion_bladder_sample_data.mat: merge_beta_scan_samples $(CION_BLADDER_FILELIST)
	./merge_beta_scan_samples $@ $(CION_BLADDER_FILELIST) && \
		rm -f $@.backup $(CION_BLADDER_FILELIST) $(foreach N,$(CION_BLADDER_FILELIST),log_$(N).txt)


$(CION_RECTUM_FILELIST): make_beta_scan_samples
	./make_beta_scan_samples $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
		'data/CionDataPhysicalDose/HUH%dphysical_dvh.mat' 12 1 Rectum \
		$(ALPHA_CION_RECTUM_MEAN) $(ALPHA_CION_RECTUM_STD) \
		$(BETA_CION_RECTUM_MIN) $(BETA_CION_RECTUM_MAX) \
...
beta_scan_cion_rectum_sample_data.mat: merge_beta_scan_samples $(CION_RECTUM_FILELIST)
	./merge_beta_scan_samples $@ $(CION_RECTUM_FILELIST) && \
		rm -f $@.backup $(CION_RECTUM_FILELIST) $(foreach N,$(CION_RECTUM_FILELIST),log_$(N).txt)


$(PROTON_BLADDER_FILELIST): make_beta_scan_samples
	./make_beta_scan_samples $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
		'data/IMPTdvh/impt%d.mat' 25 1/1.1 Bladder \
		$(ALPHA_PROTON_BLADDER_MEAN) $(ALPHA_PROTON_BLADDER_STD) \
		$(BETA_PROTON_BLADDER_MIN) $(BETA_PROTON_BLADDER_MAX) \
...
beta_scan_proton_bladder_sample_data.mat: merge_beta_scan_samples $(PROTON_BLADDER_FILELIST)
	./merge_beta_scan_samples $@ $(PROTON_BLADDER_FILELIST) && \
		rm -f $@.backup $(PROTON_BLADDER_FILELIST) $(foreach N,$(PROTON_BLADDER_FILELIST),log_$(N).txt)


$(PROTON_RECTUM_FILELIST): make_beta_scan_samples
	./make_beta_scan_samples $@ $(N_SAMPLES) 'data/VMATdvh/vmat%d.mat' 25 1 \
		'data/IMPTdvh/impt%d.mat' 25 1/1.1 Rectum \
		$(ALPHA_PROTON_RECTUM_MEAN) $(ALPHA_PROTON_RECTUM_STD) \
		$(BETA_PROTON_RECTUM_MIN) $(BETA_PROTON_RECTUM_MAX) \
...
beta_scan_proton_rectum_sample_data.mat: merge_beta_scan_samples $(PROTON_RECTUM_FILELIST)
	./merge_beta_scan_samples $@ $(PROTON_RECTUM_FILELIST) && \
