...
patient_no_alpha_beta_RBEmax_spread_$(PATIENT)_merge_samples: samples.makefile
...
patient_no_alpha_beta_RBEmax_spread_$(PATIENT)_make_samples: samples.makefile
